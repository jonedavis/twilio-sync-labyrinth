 ...
 */
/* jshint ignore:end */
function ChannelPage(version, response, serviceSid) {
 ...
 */
/* jshint ignore:end */
function ChannelList(version, serviceSid) {
  /* jshint ignore:start */
  /**
   * @function channels
 ...
 */
/* jshint ignore:end */
function ChannelInstance(version, payload, serviceSid, sid) {
 ...
 */
/* jshint ignore:end */
function ChannelContext(version, serviceSid, sid) {
  this._version = version;
